...
- Stripe : <https://stripe.com/>
  - 商品購入時の料金のコンビニ決済、および、カード決済に使用します。
  - 上記のStripe公式サイトにて<u>ユーザー登録</u>し、開発者ページにて<u>Stripe APIキー(公開可能キーとシークレットキー)を取得</u>してください。
...
本アプリではStripeを利用した「コンビニ支払い」および「カード支払い」による決済が可能です。
Stripeの仕様上の制約から、決済可能な最低金額があります。
